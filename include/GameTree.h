...
public:
    ...
    long long estimate_tree_memory(int deck_num,int p1range_num,int p2range_num,int use_halffloats=0,int num_current_deal=1);
    long long re_estimate_tree_memory(const shared_ptr<GameTreeNode>& node,int deck_num,int p1range_num,int p2range_num,int use_halffloats=0,int num_current_deal=1);
